# Anthra Systems Website

Anthra Systems is an **applied engineering and R&D company** building intelligent systems across embedded technology, automation, IoT, mechatronics, connected vehicles, and edge AI.

This is the official website and documentation portal for Anthra Systems, built with [Astro](https://astro.build/), [Tailwind CSS](https://tailwindcss.com/), and modern web technologies.

## About Anthra Systems

Engineering Intelligence for the Physical World. Anthra Systems designs and deploys intelligent systems that bridge the gap between the physical and digital worlds, enabling real-time monitoring, automation, and AI-driven insights.

### Our Locations

- **Kolhapur Office**: Anthra Office, Bapu Building, Near Urban Bank, Kurundwad, Dist: Kolhapur, Maharashtra 416106
- **Pune Office**: Office no 904, 9th floor, Gera Imperium Rise, Wipro Circle, Hinjewadi Phase 2, Pune, Maharashtra 411057

### Contact Us

- **Project Inquiries**: info@anthrasystems.com
- **General Contact**: contact@anthrasystems.com
- **Phone**: +91 8788532123
...
- **Product & Solution Documentation**: Comprehensive guides for intelligent systems
- **SEO Optimized**: Built-in SEO configuration for search engine visibility
- **Performance Optimized**: Brotli compression, image optimization, and fast page loads
